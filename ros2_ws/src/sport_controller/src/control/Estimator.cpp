...
void Estimator::_initSystem(){
    ...
    _RCheck  = std::make_shared<AvgCov>(28, _estName + " R");
    _uCheck  = std::make_shared<AvgCov>(3,  _estName + " u");

    _vxFilter = std::make_shared<LPFilter>(_dt, 3.0);
    _vyFilter = std::make_shared<LPFilter>(_dt, 3.0);
