...
inline UNITREE_LEGGED_SDK::BmsCmd rosMsg2Cmd(const unitree_legged_msgs::msg::BmsCmd &msg)
{
...
inline UNITREE_LEGGED_SDK::HighCmd rosMsg2Cmd(const unitree_legged_msgs::msg::HighCmd &msg)
{
...
inline UNITREE_LEGGED_SDK::MotorCmd rosMsg2Cmd(const unitree_legged_msgs::msg::MotorCmd &msg)
{
...
inline UNITREE_LEGGED_SDK::LowCmd rosMsg2Cmd(const unitree_legged_msgs::msg::LowCmd::SharedPtr &msg)
{
...
inline unitree_legged_msgs::msg::MotorState state2rosMsg(UNITREE_LEGGED_SDK::MotorState &state)
{
...
inline unitree_legged_msgs::msg::IMU state2rosMsg(UNITREE_LEGGED_SDK::IMU &state)
{
...
inline unitree_legged_msgs::msg::BmsState state2rosMsg(UNITREE_LEGGED_SDK::BmsState &state)
{
...
inline unitree_legged_msgs::msg::LowState state2rosMsg(UNITREE_LEGGED_SDK::LowState &state)
{
...
inline unitree_legged_msgs::msg::Cartesian state2rosMsg(UNITREE_LEGGED_SDK::Cartesian &state)
{
...
inline unitree_legged_msgs::msg::HighState state2rosMsg(UNITREE_LEGGED_SDK::HighState &state)
{
...
inline UNITREE_LEGGED_SDK::HighCmd rosMsg2Cmd(const geometry_msgs::msg::Twist &msg)
{
    UNITREE_LEGGED_SDK::HighCmd cmd;
