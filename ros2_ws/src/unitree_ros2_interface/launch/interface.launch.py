...
def generate_launch_description():
    ...
    declared_args = [
        ...
        DeclareLaunchArgument("enable_camera", default_value=TextSubstitution(text="false")),
        ...
        DeclareLaunchArgument("enable_low", default_value=TextSubstitution(text="true")),
        DeclareLaunchArgument("enable_high", default_value=TextSubstitution(text="false")),

        DeclareLaunchArgument("publish_rectified", default_value=TextSubstitution(text="false")),
        DeclareLaunchArgument("publish_depth", default_value=TextSubstitution(text="false")),
        DeclareLaunchArgument("publish_pcl", default_value=TextSubstitution(text="false")),
    ]
